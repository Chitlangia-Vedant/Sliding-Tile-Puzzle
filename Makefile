...
# IDA Source Files (Excluding wasm.cpp and the unused post.js)
IDA_SOURCES = src/IDAsolver/src/Board.cpp src/IDAsolver/src/BoardRect.cpp \
              src/IDAsolver/src/Direction.cpp src/IDAsolver/src/DisjointDatabase.cpp \
...
# --preload-file mounts your local database folder to the virtual "/databases" path
